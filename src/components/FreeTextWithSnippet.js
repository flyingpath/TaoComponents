...
var _default = FreeTextWithSnippet;
...
(function () {
    ...
    reactHotLoader.register(SnippetDiv, 'SnippetDiv', 'publish/components/FreeTextWithSnippet.js');
    reactHotLoader.register(FreeTextWithSnippet, 'FreeTextWithSnippet', 'publish/components/FreeTextWithSnippet.js');
    reactHotLoader.register(_default, 'default', 'publish/components/FreeTextWithSnippet.js');
    leaveModule(module);
})();
