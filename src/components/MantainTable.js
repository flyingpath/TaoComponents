    ...
    _createClass(MaintainTable, [{
        ...
        value: function render() {
            ...
            return React.createElement(
                'div',
                {
                    className: _JSXStyle.dynamic([['3800572425', [globalWidth]]]) + ' ' + 'AppBody'
                },
                React.createElement(
                    'div',
                    {
                        className: _JSXStyle.dynamic([['3800572425', [globalWidth]]]) + ' ' + 'table'
                    },
                    React.createElement(
                        'div',
                        {
                            className: _JSXStyle.dynamic([['3800572425', [globalWidth]]])
                        },
                        React.createElement(
                            'div',
                            {
                                className: _JSXStyle.dynamic([['3800572425', [globalWidth]]]) + ' ' + 'MT-header flex-row'
                            },
                            this.state.listColumnName.map(function (each, idx) {
                                return React.createElement(
                                    'div',
                                    { key: idx, className: _JSXStyle.dynamic([['3800572425', [globalWidth]]]) + ' ' + 'MTTD'
                                    },
                                    each.label
                                );
                            })
                        ...
                        React.createElement(
                            'div',
                            {
                                className: _JSXStyle.dynamic([['3800572425', [globalWidth]]]) + ' ' + 'MT-outter'
                            },
                            ...
                            React.createElement(
                                'div',
                                {
                                    className: _JSXStyle.dynamic([['3800572425', [globalWidth]]]) + ' ' + 'MTTR flex-row'
                                },
                                ...
                                React.createElement(
                                    'div',
                                    { onClick: this.addRow, className: _JSXStyle.dynamic([['3800572425', [globalWidth]]]) + ' ' + 'add'
                                    },
                                    '+'
                                )
                            )
...
(function () {
    ...
    reactHotLoader.register(Column, 'Column', 'publish/components/MantainTable.js');
    reactHotLoader.register(Row, 'Row', 'publish/components/MantainTable.js');
    reactHotLoader.register(AddRow, 'AddRow', 'publish/components/MantainTable.js');
    reactHotLoader.register(MaintainTable, 'MaintainTable', 'publish/components/MantainTable.js');
    reactHotLoader.register(_default, 'default', 'publish/components/MantainTable.js');
    leaveModule(module);
})();
