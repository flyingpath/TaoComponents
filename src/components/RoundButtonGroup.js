...
(function () {
    ...
    reactHotLoader.register(RoundButtonGroup, 'RoundButtonGroup', 'publish/components/RoundButtonGroup.js');
    reactHotLoader.register(_default, 'default', 'publish/components/RoundButtonGroup.js');
    leaveModule(module);
})();
