...
(function () {
    ...
    reactHotLoader.register(Checkboxes, 'Checkboxes', 'publish/components/check-boxes/CheckBoxes.js');
    reactHotLoader.register(_default, 'default', 'publish/components/check-boxes/CheckBoxes.js');
    leaveModule(module);
})();
