...
(function () {
    ...
    reactHotLoader.register(TaoDialog, 'TaoDialog', 'publish/components/dialog/Dialog.js');
    reactHotLoader.register(_default, 'default', 'publish/components/dialog/Dialog.js');
    leaveModule(module);
})();
